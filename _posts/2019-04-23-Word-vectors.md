...
<img src="/assets/img/word/gradient_descent.png" alt="gradient_descent" width="40%" height="40%"/>
...
<img src="/assets/img/word/gd2.png" alt="gradient_descent" width="40%" height="40%"/>
...
---
The probability model, $$P(o | c)=\frac{\exp \left(u_{o}^{T} v_{c}\right)}{\sum_{w \in V} \exp \left(u_{w}^{T} v_{c}\right)}$$
